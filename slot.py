...
#Function play needs to be called to execute
def play():
    #Using the keyword global - global scope
    global stake, firstWheel, secondWheel, thirdWheel
    playQuestion = askPlayer()
    # Game Loop continue while you have stake points and player wants
    while(stake != 0 and playQuestion == True):
        firstWheel = spinWheel() #Call the spin Wheel function
